...
def mostrar_registros():
    ...
    filtro_Tarea = solicitar_input("Selecciona una opción (1-4) para Ordenar: ",int) # Menu de Prioridad
    if filtro_Tarea == 1:
        filtro_Tarea = "Alta"
    elif filtro_Tarea == 2:
        filtro_Tarea = "Media"
        ...
        print(f"El numero {filtro_Tarea} no es una opción, por favor Selecciona una opción (1-3): ")
